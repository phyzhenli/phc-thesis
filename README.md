...
(1) 论文改写了第2章的本章小节，描述已有研究工作的基础上，重点说明了存在的问题，为第3章到第5章的研究工作做准备。
        (2) 对摘要、论文主体等出现的口语化内容、错别字和错误的标点符号进行修正。 如将
        (3) 对不合理的图片大小进行调整。如将原图5-9变为现图2-35、2-36并适当放大，将原图5-6变为现图2-32并适当缩小。
        (4) 论文改写了第6章 总结与展望，在总结部分强化了各个工作之间的联系，并简化了各个工作的具体内容，提升文章的阅读体验。


最后，非常感谢您审阅我的论文，并提出了宝贵的意见，我收获颇丰，意识到了简单拼凑并不能成为一个合格的博士论文。我后续考虑将论文、您的建议及我的修改过程在全部开源，以帮助有需要的人。万分感谢！
