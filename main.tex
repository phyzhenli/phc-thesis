% add by zli
\newcommand*{\Version}{Anonymous} % Anonymous non-Anonymous Open
% end by zli
...
\fdusetup{
  ...
  info = {
    ...
    %            没收程序若干问题的规定},
    %
    title* = {Highly-Efficient Approximate Multiplier Design and Synthesis},
    % 英文标题
    %
    author = {李震},
    % 作者姓名
    ...
    % 如有需要，可以用 \quad 手工对齐
    %
    keywords = {近似计算, 近似乘法器, 逻辑综合, 近似逻辑综合},
    % 中文关键词
    % 使用英文逗号 “,” 分隔
    %
    keywords* = {Approximate Computing, Approximate Multiplier, Logic Synthesis, Approximate Logic Synthesis},
    % 英文关键词
    % 使用英文逗号 “,” 分隔
    %
    clc = {TN4},
...
\usepackage{hvfloat}
\usepackage{pdfpages}
\usepackage{xstring} % ref: https://tex.stackexchange.com/questions/33576/conditional-typesetting-build
% add by zli
...
\IfStrEq{\Version}{Anonymous}{
  \begin{titlepage}
    \includepdf{盲审论文封面_李震_reviewerC.pdf}
  \end{titlepage}
}{}
\begin{sloppypar}
% end by zli
